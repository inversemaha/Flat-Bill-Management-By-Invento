        ...
        <div class="p-6.5">
            ...
            <div class="mb-6">
                ...
                <textarea
                    ...
                    class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary">{{ old('description') }}</textarea>
                @error('description')
                    <p class="text-meta-1 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
