...
<div class="py-6">
    <div class="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
                ...
                <ol class="flex items-center space-x-4">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="ml-4 text-sm font-medium text-gray-500">Edit House Owner</span>
                        </div>
                    </li>
                </ol>
            </nav>
            <h1 class="mt-4 text-2xl font-bold leading-7 text-gray-900 dark:text-white sm:text-3xl sm:tracking-tight">
                Edit House Owner: {{ $houseOwner->name }}
            </h1>
        ...
        <div class="bg-white dark:bg-gray-800 shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl">
            <form method="POST" action="{{ route('house-owners.update', $houseOwner) }}" class="px-4 py-6 sm:p-8">
                @csrf
                @method('PUT')
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm text-blue-700 dark:text-blue-300">
                                        Current status: <strong>{{ ucfirst($houseOwner->status) }}</strong>. 
                                        Use the House Owner Management page to change the approval status.
                                    </p>
                                </div>
                            </div>
                        </div>
