...
class BillCreatedMail extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: 'New Bill Created - ' . $this->bill->billCategory->name . ' (' . date('M Y', strtotime($this->bill->year . '-' . $this->bill->month . '-01')) . ')',
        );
    }
    ...
    public function content(): Content
    {
        return new Content(
            ...
            with: [
                ...
                'dueDate' => $this->bill->due_date ? $this->bill->due_date->format('M d, Y') : 'N/A',
            ]
        );
    }
